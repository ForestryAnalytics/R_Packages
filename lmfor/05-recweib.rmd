...
of the shape parameter and the mean/median diameter given in D. The function which is set to zero is implemented in func.recweib. The Gauss-Newton method implemented in NRnum is used for solving the equation.
