...
check_parcel_different_spacing
#### Description
This function checks for partitions with different spacing at i and i + 1 ages, it is necessary that the
base be paired including the field representing the spacing, doubts about how to pair its base see the
Fgmutils package
#### Usage
...
variables_to_group
variable (s) that you want to group the result of the analysis, this can be a vector
os strings or strign name to group
