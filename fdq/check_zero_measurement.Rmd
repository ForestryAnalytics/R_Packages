...
string vector containing name of the field(s) it represents measurement variable(
s) to be analyzed
state_name string vector containing the name of the variable than represents state in database
states_to_check
string vector containing the name of the the states to be checked, the user can
inform this names in a string vector like ("F","N")
